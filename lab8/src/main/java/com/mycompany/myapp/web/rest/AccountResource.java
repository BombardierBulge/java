...
public class AccountResource {
    ...
    public Mono<AdminUserDTO> getAccount() {
        AdminUserDTO dummyAdmin = new AdminUserDTO();
        dummyAdmin.setLogin("admin");
        dummyAdmin.setAuthorities(java.util.Set.of("ROLE_ADMIN", "ROLE_USER"));
        return Mono.just(dummyAdmin);
    }
