...
import { RentalOfficeDeleteDialog } from './rental-office-delete-dialog';

describe('RentalOffice Management Delete Component', () => {
  let comp: RentalOfficeDeleteDialog;
  let fixture: ComponentFixture<RentalOfficeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RentalOfficeDeleteDialog);
