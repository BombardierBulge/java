...
describe('Car Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Car', () => {
      ...
      service.create(car).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Car', () => {
      ...
      service.update(car).subscribe(resp => (expectedResult = resp));
    ...
    describe('addCarToCollectionIfMissing', () => {
      it('should add a Car to an empty array', () => {
        ...
        expect(expectedResult).toEqual([car]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([car, car2]);
      });
